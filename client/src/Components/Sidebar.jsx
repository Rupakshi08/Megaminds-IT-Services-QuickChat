...
import assets from "../assets/assets"; // ✅ Make sure assets are properly exported
  ...
  return (
    ...
    >
      ...
      <div className="pb-5">
        ...
        {/* Search Bar */}
        <div
          className="bg-[#282142] rounded-full flex items-center gap-2 py-3 px-4
          mt-5"
        >
      ...
      <div className="flex flex-col">
        {Array.isArray(filteredUsers) && filteredUsers.length > 0 ? (
          ...
          <p className="text-gray-400 text-sm mt-4 text-center">No users found</p>
        )}
      </div>
    </div>
  );
